# Agent Instructions for Flimshare OTT

## Automatic APK Build & Upload Rule
Every time you perform any code modification or visual updates to the Flimshare application, you **MUST** run the Gradle copy and upload task to generate a fresh APK, publish it, and present the download link to the user.
